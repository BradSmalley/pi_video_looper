...
class VideoLooper(object):
    ...
    def _load_player(self):
        ...
        return importlib.import_module('.' + module, 'BradSmalley_Video_Looper') \
    ...
    def _idle_message(self):
        ...
        label2 = self._render_text(self.ip)
    ...
    def run(self):
        ...
        while self._running:
            if os.path.exists('/home/pi/Videos/stop_file'):
                self._print('stop_file found.  Exiting...')
                self._player.stop(3)
                return
...
if __name__ == '__main__':
    print('Starting BradSmalley Video Looper.')
